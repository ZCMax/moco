...
def main():
    ...
    train_dataset = moco.dataset.MVImageDataset(
        traindir,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_loader, model, criterion, optimizer, epoch, args, local_rank)
...
def train(train_loader, model, criterion, optimizer, epoch, args, local_rank):
